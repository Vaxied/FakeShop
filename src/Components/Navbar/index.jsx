...
function Navbar() {
    ...
    const { count } = React.useContext(StoreContext)

    return (
        <>
            <nav className='bg-white flex justify-between items-center fixed z-10 top-0 w-full py-5 px-8 text-sm font-light border-b border-gray'>
