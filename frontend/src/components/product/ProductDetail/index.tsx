...
import ProductImgCarousel from '@components/carousel/ProductImgCarousel'
...
function ProductDetail() {
    ...
    // TODO
    // filter product id from loaded items, if it's not there fetch it from the api
    ...
    return (
        <>
            <div className='flex gap-4 bg-opacity-50 w-full min-h-96 pb-4'>
            ...
            <FeaturedReviews product={product} />
        </>
    )
}
